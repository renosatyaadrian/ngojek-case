        ...
        private static void SeedData(AppDbContext context, bool isProd)
        {
            ...
            if(!context.Drivers.Any())
            {
                ...
                context.Drivers.AddRange(
                    new Driver(){ Username = "bonigendul", FirstName = "Boni", LastName = "Gendul", Email = "bonigendul@gmail.com", PhoneNumber = "88812321", DriverLatitude = 0, DriverLongitude = 0, Balance = 200000, Blocked = false},
                    new Driver() { Username = "rijaldikurniawan", FirstName = "Rijaldi", LastName = "Kurniawan", Email = "rijaldikurniawan@gmail.com", PhoneNumber = "88812321", DriverLatitude = 0, DriverLongitude = 0, Balance = 30000, Blocked = false }
                );
